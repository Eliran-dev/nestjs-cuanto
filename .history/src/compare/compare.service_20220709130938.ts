                ...
                .then(async (res) => {
                    ...
                    for (let item of res.data.result.items) {
                        ...
                        },
                        {
                            ...
                            kspSql: (item.uinsql),
                            title: item.name,
                            priceKsp: Number(updatedItems[updatedItems.findIndex(x => x.uin == item.uin)].price)!=undefined ? Number(updatedItems[updatedItems.findIndex(x => x.uin == item.uin)].price)  :Number(item.price),
                            category: GetCategoryFromKsp.category,
                            brand: item.brandName,
                            cat: cat
                        },
