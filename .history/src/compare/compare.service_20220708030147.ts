                            ...
                            for (let product of productsArr.products) {
                                if (await this.doesExist(product.IvoryUid) == null) {
                                    ...
                                    if (kspProduct) {
                                        ...
                                        const productINDB = this.PriceCompare.findOne({ KspUid: product.KspUid }).exec()
                                        if((await productINDB).IvoryUid!=null)
                                        {
                                            console.log(product.priceIvory)
                                            let newProduct
                                            newProduct.priceIvory = product.priceIvory
                                            newProduct.category = product.category
                                            newProduct.inCharge = product.inCharge
                                        ...
                                        this.PriceCompare.updateOne(productINDB,{ IvoryUid: product.IvoryUid, priceIvory: product.priceIvory, approvalStatus: approvalStatus }).exec()
